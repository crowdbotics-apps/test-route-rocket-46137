"""
Django settings for test_route_rocket_46137 project.
...
ROOT_URLCONF = 'test_route_rocket_46137.urls'
...
WSGI_APPLICATION = 'test_route_rocket_46137.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_route_rocket_46137 API",
    "DESCRIPTION": "API documentation for test_route_rocket_46137 App",
    "VERSION": "v1",
}
